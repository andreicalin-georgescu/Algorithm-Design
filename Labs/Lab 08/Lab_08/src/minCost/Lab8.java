...
public class Lab8 {
    ...
    public static Task currentTask = Task.BELLMAN_FORD;
    ...
    public static void main(String[] argv) {
    	...
    	switch (currentTask) {
	    	...
	    	case ROY_FLOYD:
	    	{
	    		...
	    		solver.computeAllMinPaths();
	    		solver.printMinPath(g.getNode(s1), g.getNode(d1));
	    		solver.printMinPath(g.getNode(s2), g.getNode(d2));
	    		break;
	    	}
	    	...
	    	case DIJKSTRA:
	    	{
	    		...
	    		solver.printminDistance(g.getNode("Paris"));
	    		break;
	    	}
